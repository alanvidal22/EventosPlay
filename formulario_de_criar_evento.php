...
$query = "INSERT INTO  formulario_eventos (responsavel, evento, categoria, data, local, hora, duracao, seguranca, preco, atracoes, observacao) VALUES('$responavel','$evento','$categoria','$data','$local','$hora','$duracao','$seguranca', '$preco', '$atracoes', '$observacao')";
